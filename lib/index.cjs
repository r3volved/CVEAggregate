...
const { CVSS } = require(path.join(__dirname, 'cvss.cjs'))
...
class CVEAggregate { 
     ...
     * @return {Promise}
     */
    update_cisa (feedback=[], index=0, saveAtEachStage) {
     ...
     * @return {Promise}
     */
    update_epss (feedback=[], index=0, saveAtEachStage) {
     ...
     * @return {Promise}
     */
    update_cvss (feedback=[], index=0, saveAtEachStage) {
